...
declare class LowEntryXmlParserNodeAttribute { 
	Tag: string;
	Value: string;
	clone() : LowEntryXmlParserNodeAttribute;
	static C(Other: UObject): LowEntryXmlParserNodeAttribute;
}

declare class LowEntryXmlParserNode extends UObject { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): LowEntryXmlParserNode;
	static Find(Outer: UObject, ResourceName: string): LowEntryXmlParserNode;
	static StaticClass: any;
	static GetClassObject(): Class;
	static GetDefaultObject(): LowEntryXmlParserNode;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): LowEntryXmlParserNode;
	GetValue(): string;
	GetTag(): string;
	GetNextNode(): LowEntryXmlParserNode;
	GetFirstChildNode(): LowEntryXmlParserNode;
	GetChildrenNodes(): LowEntryXmlParserNode[];
	GetAttributes(): LowEntryXmlParserNodeAttribute[];
	GetAttribute(Tag: string): string;
	FindChildNode(Tag: string): LowEntryXmlParserNode;
	static C(Other: UObject): LowEntryXmlParserNode;
	GetXml(): string;
	static GetXml(UNode: LowEntryXmlParserNode): string;
}

declare class LowEntryXmlParserLibrary extends BlueprintFunctionLibrary { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): LowEntryXmlParserLibrary;
	static Find(Outer: UObject, ResourceName: string): LowEntryXmlParserLibrary;
	static StaticClass: any;
	static GetClassObject(): Class;
	static GetDefaultObject(): LowEntryXmlParserLibrary;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): LowEntryXmlParserLibrary;
	static GetXml(UNode: LowEntryXmlParserNode): string;
	static ParseXml(Xml: string): LowEntryXmlParserNode;
	static C(Other: UObject): LowEntryXmlParserLibrary;
}
...
declare class VaRestLibrary extends BlueprintFunctionLibrary { 
	...
	static C(Other: UObject): VaRestLibrary;
}
...
declare class BattleTankGameModeBase extends GameModeBase { 
	constructor(InWorld: World, Location?: Vector, Rotation?: Rotator);
	static StaticClass: any;
	static GetClassObject(): Class;
	static GetDefaultObject(): BattleTankGameModeBase;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): BattleTankGameModeBase;
...
declare class Tank extends Pawn { 
	...
	SetBarrelReference(BarrelToSet: StaticMeshComponent): void;
...
declare type ELandscapeMirrorOperation = 'MinusXToPlusX' | 'PlusXToMinusX' | 'MinusYToPlusY' | 'PlusYToMinusY' | 'RotateMinusXToPlusX' | 'RotatePlusXToMinusX' | 'RotateMinusYToPlusY' | 'RotatePlusYToMinusY';
...
declare type ELandscapeConvertMode = 'Expand' | 'Clip' | 'Resample';
declare var ELandscapeConvertMode : { Expand:'Expand',Clip:'Clip',Resample:'Resample', };
declare type ELandscapeImportResult = 'Success' | 'Warning' | 'Error';
declare var ELandscapeImportResult : { Success:'Success',Warning:'Warning',Error:'Error', };
declare type ELandscapeImportAlphamapType = 'Additive' | 'Layered';
...
declare type EColorChannel = 'Red' | 'Green' | 'Blue' | 'Alpha';
